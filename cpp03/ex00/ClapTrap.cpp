...
{
	std::cout << "(ClapTrap) Destructorr is called." << std::endl;
}
...
{
	std::cout << "ClapTrap: " << this->_name << " has taken damage " << amount << " points, decreased its hitpoint from "
		<< this->_hitPoints;
...
void	ClapTrap::beRepaired(unsigned int amount)
{
	if (this->_energyPoints <= 0)
	{
		std::cout << "ClapTrap: " << this->_name << " has no enough energy points for being repaired." << std::endl;
		return ;
	}
	else if (this->_hitPoints >= 10)
	{
		std::cout << "ClapTrap: " << this->_name << " cannot increased hit points anymore cause its hit points is full." << std::endl;
		return ;
	}
	std::cout << "ClapTrap: " << this->_name << " is repaired itself " << amount <<" points, its hit points increased from " << this->_hitPoints
